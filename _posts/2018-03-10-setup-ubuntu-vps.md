...
<ul>
<li>SSH login via root should be disabled <small><i>(explained in <a href="#ssh-lockdown">SSH Lockdown</a> below)</i></small></li>
<li>Only use ssh key authentication <small><i>(explained in <a href="#user-management">User Management</a> below)</i></small></li>
<li>Use a non-common port for ssh <small><i>(explained in <a href="#ssh-lockdown">SSH Lockdown</a> below)</i></small></li>
</ul>
