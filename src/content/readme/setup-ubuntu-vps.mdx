...
<ExpandableSection 
  title="Customizing fail2ban general settings"
  description="To make changes to fail2ban's general settings, update the <code>fail2ban.local</code> file."
  client:load>
...
<ExpandableSection 
  ...
  description="Customizing fail2ban involves editing the <code>jail.local</code> file."
  client:load>
