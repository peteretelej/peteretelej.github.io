		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						This is an XML Sitemap for <a href='/'><b>peteretelej.github.io</b></a> and is meant for consumption by search engines.
					</p>
					...
					<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
						...
						<p class="expl"><a href="https://yoast.com/sitemap_index.xml">&#8593; Sitemap Index</a></p>
						<table id="sitemap" cellpadding="3">
							<thead>
								<tr>
									<th width="75%">URL</th>
				...
				<script type="text/javascript" src="{{ site.baseurl }}/assets/js/jquery.tablesorter.min.js"></script>
